window.slidesk = {
  ...
  slides: [],
  animationTimer: 300,
  onSlideChange: function() {;window.slidesk.animateElements();;;window.slidesk.plugin_number();;window.slidesk.prepareSteps();},
  env: {"WIDTH":"1920","TITLE":"Full stack Java, du dev à la prod en passant par l'infra 🏗️"},
  cwd: '/Users/sphilipp/Developments/java-full-stack-slide/',
  lastAction: ""
};
